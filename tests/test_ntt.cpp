...
// Ensure functional correctness of (inverse) NTT implementation for degree-511 polynomial over Z_q | q = 549824583172097, using following rule
//
// f -> random polynomial
// f' = ntt(f)
// f'' = intt(f')
//
// assert(f == f'')
TEST(RaccoonSign, NumberTheoreticTransform)
{
